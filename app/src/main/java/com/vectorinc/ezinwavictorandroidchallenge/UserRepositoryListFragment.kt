 ...
 * Use the [UserRepositoryListFragment.newInstance] factory method to
...
class UserRepositoryListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UserRepositoryListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UserRepositoryListFragment().apply {
